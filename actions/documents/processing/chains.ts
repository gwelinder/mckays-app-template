...
/**
 * Generates preliminary answers and analysis for document content
 */
export async function preliminaryAnswerChainAgent(
  content: string,
  userId: string
) {
  const SystemPrompt =
...
/**
 * Generates metadata for a document including title, description, topics, and entities
 */
